package com.example.lenovo.se_project.services;
...
import com.example.lenovo.se_project.NotificationMusic;
import com.example.lenovo.se_project.R;
import com.example.lenovo.se_project.kMP;
import com.example.lenovo.se_project.external.RemoteControlClientCompat;
import com.example.lenovo.se_project.external.RemoteControlHelper;
import com.example.lenovo.se_project.model.Song;
...
public class ServicePlayMusic extends Service
	 ...
	 */
	public static final String BROADCAST_ACTION = "com.example.lenovo.se_project.MUSIC_SERVICE";

	/** String used to get the current state Extra on the Broadcast Intent */
	public static final String BROADCAST_EXTRA_STATE = "x_rohan";
    ...
    // AndroidManifest.xml.
    public static final String BROADCAST_ORDER = "com.example.lenovo.se_project.MUSIC_SERVICE";
    public static final String BROADCAST_EXTRA_GET_ORDER = "com.example.lenovo.se_project.dasdas.MUSIC_SERVICE";

    public static final String BROADCAST_ORDER_PLAY            = "com.example.lenovo.se_project.action.PLAY";
    public static final String BROADCAST_ORDER_PAUSE           = "com.example.lenovo.se_project.action.PAUSE";
    public static final String BROADCAST_ORDER_TOGGLE_PLAYBACK = "dlsadasd";
    public static final String BROADCAST_ORDER_STOP            = "com.example.lenovo.se_project.action.STOP";
    public static final String BROADCAST_ORDER_SKIP            = "com.example.lenovo.se_project.action.SKIP";
    public static final String BROADCAST_ORDER_REWIND          = "com.example.lenovo.se_project.action.REWIND";
