 ...
 */
public class playerUI extends ActionBarActivity implements MediaController.MediaPlayerControl {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("shib1", str);
        setContentView(R.layout.playerui);
    ...
    class UpdateDB extends AsyncTask<String, String, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(playerUI.this);
        ...
        protected void onPostExecute(Void v) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    SongAdapter songAdt = new SongAdapter(playerUI.this, songList);
                    songView.setAdapter(songAdt);
                    setController();
                }
            });
