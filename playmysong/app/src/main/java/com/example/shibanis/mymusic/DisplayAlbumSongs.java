...
public class DisplayAlbumSongs extends Activity implements MediaPlayerControl {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("shib1",str);
        setContentView(R.layout.displayalbumsongs);
   ...
   /* class UpdateDB extends AsyncTask<String, String, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(DisplayAlbumSongs.this);
        ...
        protected void onPostExecute(Void v) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    SongAdapter songAdt = new SongAdapter(DisplayAlbumSongs.this, songList);
                    songView.setAdapter(songAdt);
                    setController();
                }
            });
